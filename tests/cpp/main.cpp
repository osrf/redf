...
int main(int argc, char* argv[]) {
  ...
  auto server = test_node->create_service<TestService::ServiceType>(
    TestService::service_name(), [](std::shared_ptr<rmw_request_id_t>, TestService::ServiceType::Request::SharedPtr, TestService::ServiceType::Response::SharedPtr) {});
  ...
  auto action_server = rclcpp_action::create_server<TestAction::ActionType>(
    test_node, TestAction::action_name(),
    [](const rclcpp_action::GoalUUID&, TestAction::ActionType::Goal::ConstSharedPtr) { return rclcpp_action::GoalResponse::ACCEPT_AND_EXECUTE; },
    [](std::shared_ptr<rclcpp_action::ServerGoalHandle<TestAction::ActionType>>) { return rclcpp_action::CancelResponse::ACCEPT; },
